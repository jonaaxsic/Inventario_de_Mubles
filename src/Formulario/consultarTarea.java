...
public final class consultarTarea extends javax.swing.JFrame {
     ...
     */
    public consultarTarea()throws SQLException {
        initComponents();
        this.setLocationRelativeTo(null);
        LlenarTabla("");
    }
    
    void LlenarTabla(String filtroDescipcion_Tarea)throws SQLException{
      try {
    ...
    try {
        ...
        String sql = "SELECT Id_tarea, Descripcion_Tarea, Tipo_Tarea, Fecha_creacion FROM Tareas";
        if (filtroDescipcion_Tarea != null && !filtroDescipcion_Tarea.trim().isEmpty()) {
            sql += " WHERE Descripcion_Tarea LIKE '%" + filtroDescipcion_Tarea + "%'";
        }

        rs = control.mandarQUERY(sql);
        String[] fila = new String[4];
        while (rs.next()) {
            fila[0] = rs.getString("Id_tarea");
            fila[1] = rs.getString("Descripcion_Tarea");
            fila[2] = rs.getString("Tipo_Tarea");
        ...
        logger.log(Level.SEVERE, "Error al cargar tareas en la tabla desde la base de datos.", ex);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Tipo de Tarea");

        jbtSearch.setBackground(new java.awt.Color(63, 81, 110));
        jbtSearch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Formulario/tarea.png"))); // NOI18N
    ...
    private void jbtSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSearchActionPerformed
       try {
        ...
        Logger.getLogger(consultarTarea.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    try {
        ...
        String sql = "SELECT Id_tarea, Descripcion_Tarea, Tipo_Tarea, Fecha_creacion FROM Tareas WHERE Descripcion_Tarea LIKE '%" + jtfBuscarNom.getText() + "%'";
        rs = control.mandarQUERY(sql);
        ...
        Logger.getLogger(consultarTarea.class.getName()).log(Level.SEVERE, null, ex);
        JOptionPane.showMessageDialog(null, "Error al consultar tareas: " + ex.getMessage(), "Error de Base de Datos", JOptionPane.ERROR_MESSAGE);
    }
